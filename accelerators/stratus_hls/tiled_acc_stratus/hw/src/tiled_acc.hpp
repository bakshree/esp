...
#ifndef __TILED_ACC_HPP__
#define __TILED_ACC_HPP__

#include "tiled_acc_conf_info.hpp"
#include "tiled_acc_debug_info.hpp"

#include "esp_templates.hpp"

#include "tiled_acc_directives.hpp"
...
#define PLM_OUT_WORD 16
#define PLM_IN_WORD 16

class tiled_acc : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(tiled_acc);
    tiled_acc(const sc_module_name& name)
