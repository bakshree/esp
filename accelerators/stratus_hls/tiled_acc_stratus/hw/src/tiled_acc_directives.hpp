...
#ifndef __TILED_ACC_DIRECTIVES_HPP__
#define __TILED_ACC_DIRECTIVES_HPP__

#if (DMA_WIDTH == 32)
#define DMA_BEAT_PER_WORD 2
#define DMA_WORD_PER_BEAT 0
#define PLM_IN_NAME "tiled_acc_plm_block_in_dma32"
#define PLM_OUT_NAME "tiled_acc_plm_block_out_dma32"
#elif (DMA_WIDTH == 64)
#define DMA_BEAT_PER_WORD 1
#define DMA_WORD_PER_BEAT 1
#define PLM_IN_NAME "tiled_acc_plm_block_in_dma64"
#define PLM_OUT_NAME "tiled_acc_plm_block_out_dma64"
#endif
...
#endif /* __TILED_ACC_DIRECTIVES_HPP_ */
